		...
		$this->tab_data = array(
			...
			'questions' => array(
				...
				$this->tab_help_question_response(
					...
					sprintf(__( 'Please, review these topics in <a href=%s target=_blank>our documentation</a>.','phone-orders-for-woocommerce' ), 'https://docs.algolplus.com/phone-order-for-woocommerce/')
				),
			),
		);
		?>
