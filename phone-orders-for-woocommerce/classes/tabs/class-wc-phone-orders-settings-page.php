		...
		$this->tab_data = array(
			...
			'baseSettings'                => array(
				'commonSettings'     => array(
					...
					'googleMapAPIHideRoutesLabel'    => __( 'Hide results without house number', 'phone-orders-for-woocommerce' ),
                    'googleMapAPISelectedCountriesLabel'=> __( 'Display autocomplete results only for selected countries (Google Map API)', 'phone-orders-for-woocommerce' ),
                    'googleMapAPIMaximumCountriesMsg' => __( 'The maximum number of countries that can be selected', 'phone-orders-for-woocommerce' ),
                    ...
                    'googleMapAPISelectedCountries'  => $this->option_handler->get_option( 'google_map_api_selected_countries' ),
                    ...
                    'allowToCreateOrdersWithoutPaymentLabel' => __( 'Allow to create orders without payment', 'phone-orders-for-woocommerce' ),
					'allowToCreateOrdersWithoutPayment'	    => $this->option_handler->get_option( 'allow_to_create_orders_without_payment' ),
				),
				...
				'layoutSettings'     => array(
                    ...
                    'showOrderCurrencySelectorLabel' => __( 'Show currency selector', 'phone-orders-for-woocommerce' ),
